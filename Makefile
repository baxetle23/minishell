...
SORCES	= minishell.c ft_comm_redirect_utils.c ft_lst_clears.c ft_lst_prints.c ft_commands_checks.c ft_commands_utils_2.c ft_commands_utils.c ft_commands.c ft_environments.c ft_str_utils.c ft_lst_utils_cmd.c ft_lst_utils_env.c ft_lst_utils_words.c ft_other_prints.c ft_signals.c ft_split_words.c ft_split_words_utils.c ft_utils_other.c ft_utils.c
